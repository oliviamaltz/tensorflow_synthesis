...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--outputdir", default="/zpool/vladlab/active_drive/omaltz/git_repos/tensorflow_synthesis/output_teststim")
    parser.add_argument("-i", "--imagepath", default="/zpool/vladlab/active_drive/omaltz/git_repos/tensorflow_synthesis/original_teststim")
